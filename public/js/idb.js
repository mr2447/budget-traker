...
function uploadBuget() {
    ...
    getAll.onsuccess = function() {
        ...
        if(getAll.result.length > 0) {
            ...
            .catch(err => {
               console.log('catch error upload Buget from iDB: ', err);
            }); 
        }
    }
};
...
//app refresh, idb doesn't upload to server
// on heroku, index.js line 116, 19 .unshift and .reduce are not functions 